  ...
  return (
    <main className={cn("flex min-h-screen flex-col items-center justify-between p-24",monstserrat.className)}>
      <div>
        ...
        <Button className="mt-[70px]"><Link href="/dashboard">Get started</Link></Button>
        <h2 className="text-blue-700 mr-0 mt-5">Powered by Google AI</h2>
        <Image src={Gemini} alt="Gemini" className="w-[300px] h-[80px] mt-10" />
        </div>
        <div className="mt-[100px] font-semibold">
        <h2>We use the latest gemini pro model <span className="text-blue-700">To</span> generate</h2>
        <h2>We tailored the model to provide you the best result</h2>
        </div>
      </div>
      <div className="mb-12 text-xl mt-[100px]">
